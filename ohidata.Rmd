...
Just a heads up that ohiCovidMetrics requires R 4.0 and the `sf` and `ROBDC` packages. Upgrade to a major R version, requires reinstalling all your packages, such as `tidyverse`.
